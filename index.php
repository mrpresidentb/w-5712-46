...
<nav class="navbar">
    <div class="nav-container">
        ...
        <div class="nav-menu">
            ...
            <a href="<?php echo home_url('/pricing'); ?>" class="nav-link">Pricing</a>
            <a href="<?php echo home_url('/blog'); ?>" class="nav-link">Blog</a>
            <a href="tel:+17045200809" class="nav-cta">Call (704) 520-0809</a>
        </div>
        ...
        <div class="mobile-menu" id="mobile-menu">
            ...
            <a href="tel:+17045200809" class="mobile-nav-cta">Call (704) 520-0809</a>
        </div>
    </div>
</nav>
    ...
    <div class="footer-container">
        <div class="footer-grid">
            ...
            <div class="footer-column">
                <h3 class="footer-title">IT Carolina</h3>
                <p class="footer-description">
                    Professional computer repair and IT support services for Charlotte, NC residents and small businesses.
                </p>
                <div class="footer-contact">
                    <p><strong>Phone:</strong> <a href="tel:+17045200809">(704) 520-0809</a></p>
                    <p><strong>Email:</strong> <a href="mailto:hello@itcarolina.us">hello@itcarolina.us</a></p>
                </div>
            </div>
            ...
            <div class="footer-column">
                ...
                <ul class="footer-links">
                    ...
                    <li><a href="<?php echo home_url('/services/computer-repair'); ?>">Computer Repair</a></li>
                    <li><a href="<?php echo home_url('/services/printer-support'); ?>">Printer Support</a></li>
                    <li><a href="<?php echo home_url('/services/web-hosting'); ?>">Web Hosting</a></li>
                    <li><a href="<?php echo home_url('/services/business-support'); ?>">Business Support</a></li>
                </ul>
            </div>
        ...
        <div class="footer-bottom">
            <p>&copy; <?php echo date('Y'); ?> IT Carolina. All rights reserved.</p>
        </div>
    </div>
</footer>
